...
def evolve_edge_inversion(population_size: int, fitness_evaluations: int):
...
best_route, best_distance = evolve_edge_inversion(population_size, fitness_evaluations)
